...
public class Message {
	...
	// request message type for client test results
	public final static byte DATA_LOAD_INBOX = 12;

	// request message type for client test results
	public final static byte DATA_INBOX = 13;

	// request message type for client test results
	public final static byte DATA_CLASSIFY_MESSAGES = 14;

	// request message type for client test results
	public final static byte DATA_CLASSIFY = 15;

	// request message type for client test results
	public final static byte DATA_REPORT_SPAM = 16;
	...
	public static boolean isData(byte type) {
		return (type == DATA_TRAINING_RESULTS || type == DATA_TO_TEST
				...
				|| type == DATA_INBOX || type == DATA_LOAD_INBOX
                || type ==DATA_CLASSIFY_MESSAGES || type==DATA_CLASSIFY || type == DATA_REPORT_SPAM);
	}
